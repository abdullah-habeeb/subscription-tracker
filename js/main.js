...
// --- Server-Side Analytics (Cloud Function call) ---
async function fetchServerReport() {
  ...
  try {
    ...
    serverTimestampEl.textContent = `Generated by Cloud Function at ${ts.toLocaleTimeString('en-IN')} on ${ts.toLocaleDateString('en-IN')}`;
    ...
    serverTimestampEl.textContent = 'Could not reach server. Is the function deployed?';
